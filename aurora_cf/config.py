...
DATASET_CONFIGS: Dict[str, Dict[str, Any]] = {
    "ICEWS18": {
        "embed_dim":       256,
        "k_neighbors":     32,
        "hist_len":        20,     # number of snapshot steps to look back
        "gru_layers":      2,
        "dropout":         0.3,
        "copy_lambda":     0.5,
        "recency_steps":   2,
        ...
        "infonce_temp":    0.07,
        "label_smoothing": 0.1,
        "neural_init_scale": -3.0,  # sigmoid(-3)*2 ≈ 0.10 — neural starts small
    },
    "WIKI": {
        "embed_dim":       256,
        "k_neighbors":     64,
        ...
        "gru_layers":      2,
        "dropout":         0.2,
        "copy_lambda":     0.05,   # very slow decay: WIKI facts persist long
        "recency_steps":   5,
        "recency_boost":   10.0,
        "use_entity_copy": True,
        "epochs":          50,
